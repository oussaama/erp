...
class typeEtablissementEdit extends AbstractType
{

    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        $builder->add('fichier', FileType::class, array('label' => 'Signature Directeur', 'required' => false, 'attr' => array( 'class' => 'form-control', 'placeholder' => "Signature directeur de l'etablissement")))
        ...
        ->add('file', FileType::class, array('label' => 'Logo',  'required' => false,'attr' => array('class' => 'form-control', 'placeholder' => "Logo de l'etablissement")))
        ->add('siteWeb', textType::class, array('label' => 'Site web', 'required' => true, 'attr' => array('data-validation' => "required", 'class' => 'form-control', 'placeholder' => "site web de l'etablissement")))
            ->add('update', SubmitType::class, array('attr' => array('class' => 'btn btn-primary site-btn ')));
    }
