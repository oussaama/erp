 ...
 */
namespace ERPBundle\Redirection;
...
class AfterLoginRedirection implements AuthenticationSuccessHandlerInterface
{
    ...
    public function onAuthenticationSuccess(Request $request, TokenInterface $token)
    {
        ...
        }else if(in_array('ROLE_ETUDIANT', $rolesTab, true)){
            $redirection = new RedirectResponse($this->router->generate('etudiant_homepage'));
        }else if(in_array('ROLE_ENSEIGNANT', $rolesTab, true)){
            $redirection = new RedirectResponse($this->router->generate('enseignant_homepage'));
        }
        return $redirection;
    }
}