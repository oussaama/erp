    ...
    public function match($pathinfo)
    {
        ...
        elseif (0 === strpos($pathinfo, '/e')) {
            if (0 === strpos($pathinfo, '/etudiant')) {
                ...
                if (0 === strpos($pathinfo, '/etudiant/mail')) {
                    // etudiant_mailBox
        ...
        if (0 === strpos($pathinfo, '/cour')) {
            ...
            if (preg_match('#^/cour/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if ('DELETE' !== $canonicalMethod) {
                    $allow[] = 'DELETE';
                    goto not_cour_delete;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'cour_delete')), array (  '_controller' => 'ERPBundle\\Controller\\Front\\Enseignant\\CourController::deleteAction',));
            }
            not_cour_delete:
            ...
            if (preg_match('#^/cour/(?P<id>[^/]++)/delete$#s', $pathinfo, $matches)) {
                if (!in_array($canonicalMethod, array('GET', 'POST'))) {
                    $allow = array_merge($allow, array('GET', 'POST'));
                    goto not_cour_deleteCour;
                }

                return $this->mergeDefaults(array_replace($matches, array('_route' => 'cour_deleteCour')), array (  '_controller' => 'ERPBundle\\Controller\\Front\\Enseignant\\CourController::deleteCourAction',));
            }
            not_cour_deleteCour:
