 ...
 */
class Appsense extends \ERPBundle\Entity\Appsense implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ERPBundle\\Entity\\Appsense' . "\0" . 'id', '' . "\0" . 'ERPBundle\\Entity\\Appsense' . "\0" . 'dateAppsense', '' . "\0" . 'ERPBundle\\Entity\\Appsense' . "\0" . 'dateFinAppsense', '' . "\0" . 'ERPBundle\\Entity\\Appsense' . "\0" . 'etudiant', '' . "\0" . 'ERPBundle\\Entity\\Appsense' . "\0" . 'enseignant', '' . "\0" . 'ERPBundle\\Entity\\Appsense' . "\0" . 'matiere'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Appsense $proxy) {
    ...
    public function setDateAppsense($dateAppsense)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setDateAppsense', [$dateAppsense]);

        return parent::setDateAppsense($dateAppsense);
    }
    ...
    public function getDateAppsense()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getDateAppsense', []);

        return parent::getDateAppsense();
    }
    ...
    public function setdateFinAppsense($dateFinAppsense)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setdateFinAppsense', [$dateFinAppsense]);

        return parent::setdateFinAppsense($dateFinAppsense);
    }
    ...
    public function getdateFinAppsense()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getdateFinAppsense', []);

        return parent::getdateFinAppsense();
    }
