 ...
 */
class Diplome extends \ERPBundle\Entity\Diplome implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ERPBundle\\Entity\\Diplome' . "\0" . 'id', '' . "\0" . 'ERPBundle\\Entity\\Diplome' . "\0" . 'nom', '' . "\0" . 'ERPBundle\\Entity\\Diplome' . "\0" . 'enabled', '' . "\0" . 'ERPBundle\\Entity\\Diplome' . "\0" . 'dateAjout', '' . "\0" . 'ERPBundle\\Entity\\Diplome' . "\0" . 'etudiant', '' . "\0" . 'ERPBundle\\Entity\\Diplome' . "\0" . 'filiere', '' . "\0" . 'ERPBundle\\Entity\\Diplome' . "\0" . 'Etablissement'];
        }
