 ...
 */
class Status extends \ERPBundle\Entity\Status implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ERPBundle\\Entity\\Status' . "\0" . 'id', '' . "\0" . 'ERPBundle\\Entity\\Status' . "\0" . 'type', '' . "\0" . 'ERPBundle\\Entity\\Status' . "\0" . 'payment'];
        }
