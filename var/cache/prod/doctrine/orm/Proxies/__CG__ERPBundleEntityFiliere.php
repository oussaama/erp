 ...
 */
class Filiere extends \ERPBundle\Entity\Filiere implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ERPBundle\\Entity\\Filiere' . "\0" . 'id', '' . "\0" . 'ERPBundle\\Entity\\Filiere' . "\0" . 'filiere', '' . "\0" . 'ERPBundle\\Entity\\Filiere' . "\0" . 'enabled', '' . "\0" . 'ERPBundle\\Entity\\Filiere' . "\0" . 'specialite', '' . "\0" . 'ERPBundle\\Entity\\Filiere' . "\0" . 'Etablissement', '' . "\0" . 'ERPBundle\\Entity\\Filiere' . "\0" . 'diplome', '' . "\0" . 'ERPBundle\\Entity\\Filiere' . "\0" . 'etudiant'];
        }
