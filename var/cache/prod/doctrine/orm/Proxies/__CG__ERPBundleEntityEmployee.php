 ...
 */
class Employee extends \ERPBundle\Entity\Employee implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'ERPBundle\\Entity\\Employee' . "\0" . 'Etablissement', '' . "\0" . 'ERPBundle\\Entity\\Employee' . "\0" . 'fullName', '' . "\0" . 'ERPBundle\\Entity\\Employee' . "\0" . 'cin', '' . "\0" . 'ERPBundle\\Entity\\Employee' . "\0" . 'adresse', '' . "\0" . 'ERPBundle\\Entity\\Employee' . "\0" . 'ville', '' . "\0" . 'ERPBundle\\Entity\\Employee' . "\0" . 'cp', '' . "\0" . 'ERPBundle\\Entity\\Employee' . "\0" . 'pays', '' . "\0" . 'ERPBundle\\Entity\\Employee' . "\0" . 'tel', '' . "\0" . 'ERPBundle\\Entity\\Employee' . "\0" . 'poste', '' . "\0" . 'ERPBundle\\Entity\\Employee' . "\0" . 'salaire', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
