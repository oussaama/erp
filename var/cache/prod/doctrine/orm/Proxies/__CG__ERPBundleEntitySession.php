 ...
 */
class Session extends \ERPBundle\Entity\Session implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ERPBundle\\Entity\\Session' . "\0" . 'id', '' . "\0" . 'ERPBundle\\Entity\\Session' . "\0" . 'nom', '' . "\0" . 'ERPBundle\\Entity\\Session' . "\0" . 'dateDebut', '' . "\0" . 'ERPBundle\\Entity\\Session' . "\0" . 'dateFin'];
        }
