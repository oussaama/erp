 ...
 */
class Semestre extends \ERPBundle\Entity\Semestre implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ERPBundle\\Entity\\Semestre' . "\0" . 'id', '' . "\0" . 'ERPBundle\\Entity\\Semestre' . "\0" . 'nom', '' . "\0" . 'ERPBundle\\Entity\\Semestre' . "\0" . 'dateDebut', '' . "\0" . 'ERPBundle\\Entity\\Semestre' . "\0" . 'dateFin', '' . "\0" . 'ERPBundle\\Entity\\Semestre' . "\0" . 'note', '' . "\0" . 'ERPBundle\\Entity\\Semestre' . "\0" . 'unite'];
        }
