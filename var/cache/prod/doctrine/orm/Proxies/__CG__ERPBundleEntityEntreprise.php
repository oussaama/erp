 ...
 */
class Entreprise extends \ERPBundle\Entity\Entreprise implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'ERPBundle\\Entity\\Entreprise' . "\0" . 'Etablissement', '' . "\0" . 'ERPBundle\\Entity\\Entreprise' . "\0" . 'fullName', '' . "\0" . 'ERPBundle\\Entity\\Entreprise' . "\0" . 'directeur', '' . "\0" . 'ERPBundle\\Entity\\Entreprise' . "\0" . 'adresse', '' . "\0" . 'ERPBundle\\Entity\\Entreprise' . "\0" . 'ville', '' . "\0" . 'ERPBundle\\Entity\\Entreprise' . "\0" . 'cp', '' . "\0" . 'ERPBundle\\Entity\\Entreprise' . "\0" . 'pays', '' . "\0" . 'ERPBundle\\Entity\\Entreprise' . "\0" . 'tel', '' . "\0" . 'ERPBundle\\Entity\\Entreprise' . "\0" . 'domaine', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
    ...
    public function setSpetialite($spetialite)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'setSpetialite', [$spetialite]);

        return parent::setSpetialite($spetialite);
    }
    ...
    public function getSpetialite()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getSpetialite', []);

        return parent::getSpetialite();
    }
