 ...
 */
class Notification extends \ERPBundle\Entity\Notification implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ERPBundle\\Entity\\Notification' . "\0" . 'id', '' . "\0" . 'ERPBundle\\Entity\\Notification' . "\0" . 'contenu', '' . "\0" . 'ERPBundle\\Entity\\Notification' . "\0" . 'dateAjoute', '' . "\0" . 'ERPBundle\\Entity\\Notification' . "\0" . 'notif', '' . "\0" . 'ERPBundle\\Entity\\Notification' . "\0" . 'user'];
        }
