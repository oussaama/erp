 ...
 */
class Retard extends \ERPBundle\Entity\Retard implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ERPBundle\\Entity\\Retard' . "\0" . 'id', '' . "\0" . 'ERPBundle\\Entity\\Retard' . "\0" . 'nombre', '' . "\0" . 'ERPBundle\\Entity\\Retard' . "\0" . 'dateModif', '' . "\0" . 'ERPBundle\\Entity\\Retard' . "\0" . 'user'];
        }
