 ...
 */
class Enseignant extends \ERPBundle\Entity\Enseignant implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'Etablissement', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'fullName', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'cin', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'adresse', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'ville', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'cp', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'pays', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'tel', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'specialite', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'grade', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'cour', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'examen', '' . "\0" . 'ERPBundle\\Entity\\Enseignant' . "\0" . 'appsense', 'username', 'usernameCanonical', 'email', 'emailCanonical', 'enabled', 'salt', 'password', 'plainPassword', 'lastLogin', 'confirmationToken', 'passwordRequestedAt', 'groups', 'roles'];
        }
