 ...
 */
class Type extends \ERPBundle\Entity\Type implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ERPBundle\\Entity\\Type' . "\0" . 'id', '' . "\0" . 'ERPBundle\\Entity\\Type' . "\0" . 'name', '' . "\0" . 'ERPBundle\\Entity\\Type' . "\0" . 'payment'];
        }
