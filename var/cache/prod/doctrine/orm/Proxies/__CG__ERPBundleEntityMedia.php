 ...
 */
class Media extends \ERPBundle\Entity\Media implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', '' . "\0" . 'ERPBundle\\Entity\\Media' . "\0" . 'id', '' . "\0" . 'ERPBundle\\Entity\\Media' . "\0" . 'nom', '' . "\0" . 'ERPBundle\\Entity\\Media' . "\0" . 'contact'];
        }
