...
$catalogue = new MessageCatalogue('fa', array (
  ...
  array (
    ...
    'craueFormFlow.previousStepInvalid' => 'مقادیر وارد شده در گام %stepNumber% نامعتبر هستند. لطفاً یک مرحله به عقب بازگردید و مجدداً اطلاعات را ثبت نمایید.',
    'craueFormFlow.flowExpired' => 'این فرم منقضی شده است. لطفا مجددا تلاش کنید.',
  ),
  'security' => 
  array (
